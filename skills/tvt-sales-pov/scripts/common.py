...
Duplicated verbatim from tvt-sales-prospect/scripts/common.py per the self-contained-skill
convention (spec 007 rationale: each skill vendors its own copy so it installs standalone).
"""
import json
import sys
